    ...
    <div class="container" margin-bottom="20px">
        ...
        if ($query->rowCount() > 0) {
            foreach ($results as $result) { ?>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <img src="<?php echo (strpos($result->PackageImage, 'http') === 0) ? htmlentities($result->PackageImage) : 'admin/pacakgeimages/' . htmlentities($result->PackageImage); ?>" class="img-responsive"
